...
import '../../services/reqs/timetable/connection.dart';
...
class TimeTableNotifier with ChangeNotifier {
  ...
  Box b;
  TimeTableNotifier() {
    _data = _launchData[0] == null
        ? tts.isEmpty
            ? null
            : tts.last
        : _launchData[0];
    _ttIndex = _launchData[1] ?? _today;
    if (_fullData.isNotEmpty) {
      _updateTTalias();
    }
