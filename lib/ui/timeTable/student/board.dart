...
import 'main.dart';
import '../../../logic/student/db_models/timetable/timetable.dart';
import '../../../logic/shared/services/network_connection/networkConnectivity.dart';
import '../../../logic/student/services/timetable/network_feedback.dart';
...
class TimeTableBoardState extends State<TimeTableBoard> {
  ...
  List<Period> getTodayData({List<TimeTable> tts}) {
    ...
    return tt != null ? tt.periods[todayDate.weekday - 1] : null;
  }
}
